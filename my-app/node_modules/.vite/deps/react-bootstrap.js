...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-HRMVBFER.js";
import {
  BreadcrumbItem_default,
  Breadcrumb_default
} from "./chunk-FDNT4VGN.js";
import {
  Anchor_default,
  Button_default,
  useButtonProps,
...
var FormFloating = React57.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React58.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormLabel = React59.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "label",
  bsPrefix,
  column = false,
...
var FormRange = React60.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React61.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React62.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React63.forwardRef((props, ref) => (0, import_jsx_runtime64.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React64.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var NavDropdown = React76.forwardRef(({
  ...
  return (0, import_jsx_runtime79.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames62.default)(className, navItemPrefix),
...
var Popover = React81.forwardRef(({
  ...
  return (0, import_jsx_runtime83.jsxs)("div", {
    ...
    className: (0, import_classnames65.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
  ...
  return (0, import_jsx_runtime86.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React83.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames67.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var PageItem = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames68.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime91.jsxs)(Component2, {
      className: (0, import_classnames68.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
...
var Pagination = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames69.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames70.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime95.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames71.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime96.jsx)("div", {
    ...
    className: (0, import_classnames72.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime97.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames73.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames74.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var Table = React100.forwardRef(({
  ...
  const classes = (0, import_classnames78.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
